...
start_date_options = {
    "1 mes": end_date - timedelta(days=30*1.2),
    "3 meses": end_date - timedelta(days=90*1.2),
    "6 meses": end_date - timedelta(days=180*1.2),
    "1 año": end_date - timedelta(days=365*1.2),
}
